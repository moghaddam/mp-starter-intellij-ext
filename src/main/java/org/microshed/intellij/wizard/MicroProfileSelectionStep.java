 ...
 */
public class MicroProfileSelectionStep extends ModuleWizardStep {
    ...
    public MicroProfileSelectionStep(ModuleInitializationData moduleCreationData, WizardContext context) {
    ...
    public JComponent getComponent() {
        ...
        if (specMatrix == null) {
            rootPanel.add(new JLabel("Fetching MicroProfile specs from " + MicroProfileModuleBuilder.STARTER_REST_BASE_URL + " failed."));
            return rootPanel;
        }
